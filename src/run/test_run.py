...
def run_sequential(args, logger):
    ...
    if args.checkpoint_path != "":
        ...
        for name in os.listdir(checkpoint_model_path):
            full_name = os.path.join(checkpoint_model_path, name)
        ...
        model_path = os.path.join(checkpoint_model_path, str(timestep_to_load))
