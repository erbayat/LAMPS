...
def update_config(config_dict, params):
    keys = [
        "estimation", "utility", "save_model", "model_name", 
        "batch_size_run", "name", "runner", "run", "mac"
    ]
    for key in keys:
        config_dict[key] = parse_command(params, key, config_dict[key])
...
if __name__ == '__main__':
    ...
    update_config(config_dict, params)
